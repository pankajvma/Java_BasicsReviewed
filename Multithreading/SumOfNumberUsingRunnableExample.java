...
public class SumOfNumberUsingRunnableExample {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Worker2Parallel worker2Parallel = new Worker2Parallel(numbers);
         ...
         thread1.join();  //calling thread i. e. main in this case will wait for thread1 to finish
         thread2.join();  //after thread 1 is executed successfully now, main thread will wait for thread2 to finish before executing further
